...
operate on a strictly "first in, first out" basis. 
...
The cannot select which specific animal they would like. 
Create the data strutures to maintain this system and implement operations
