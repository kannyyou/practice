...
Finally, we consider each connected component, 
merging all of its intervals by constructing a new Interval with start equal 
to the minimum start among them and end equal to the maximum end.
...
Traversing the graph has the same cost (although it might appear higher at first)
 ...
 Finally, because each node is part of exactly one component, the merge step costs
  O(V) = O(n) time. This all adds up as follows:
...
Output: [[1,6],[8,10],[15,18]]
	...
	public static void main(String[] args) {
		...
		System.out.println(sol1.merge(input1).toString());

		Solution2 sol2 = new Solution2();
		System.out.println(sol2.merge(input1).toString());
