...
public class L392_IsSubsequence {
	...
	public static void main(String[] args) {
		...
		System.out.println(Solution.isSubsequence("abc", "ahbadc"));
		System.out.println(Solution.isSubsequence("axc", "ahbgdc"));

		
		System.out.println(Solution2.isSubsequence("abc", "bahbgdca"));
		System.out.println(Solution2.isSubsequence("abc", "bahgdcb"));
	}
}
