...
public class L8_StringToInt {
	...
	public static int atoi(String str) {
		...
		// convert number.  If there is space, remove space
		while (index < str.length()) {
			int digit = str.charAt(index) - '0';
			if (digit < 0 || digit > 9) break;	//in case that there is a space between number, stop
			
			if (Integer.MAX_VALUE/10 < returnInt || Integer.MAX_VALUE/10 == returnInt && Integer.MAX_VALUE % 10 < digit) {
