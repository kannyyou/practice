...
//					System.out.println(" remove");
	...
	public static void main(String[] args) {
		int [] nums = {1,2,3, 4};
		System.out.println(Solution1.permute(nums, 2).toString());
		System.out.println(Solution1.permute(nums, 3).toString());

		int [] nums2 = {1,2,3, 4};

		System.out.println(Solution2.permute(nums2, 2).toString());
		System.out.println(Solution2.permute(nums2, 3).toString());
