package com.changhun.z.dynamic;
/**
...
It can be easily analysed that dp[i]is nothing but i^{th}
  fibonacci number.
...
Now we just have to find n^{th}
  ...
  number of the fibonacci series having 1 and 2 their first and second term respectively, 
...
Space complexity : O(1). Constant space is used. 
	...
	public static void main(String[] args) {
		System.out.println(Solution1.climbStairs(5));
		System.out.println(Solution2.climbStairs(5));
		System.out.println(Solution3.climbStairs(5));
		System.out.println(Solution4.climbStairs(5));
