...
and recur for remaining indexes. Let the input array be {1, 2, 3, 4, 5} and r be 3.
 ...
 Finally, we fix 3 and recur for remaining indexes. When number of elements in data[] 
 becomes equal to r (size of a combination), we print data[].

Following diagram shows recursion tree for same input.
 */

public class PermuationSubsetWithSize {
